...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void requestPermission(){
        ...
        int checkReadPermission = ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE);
        int checkWritePermission = ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);

        if (checkReadPermission != PackageManager.PERMISSION_GRANTED){      //  是否已经授予权限
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},1);
        }else {
            Toast.makeText(MainActivity.this, "READ_EXTERNAL_STORAGE",Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode)
        {
            case 1:
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(MainActivity.this, "READ_EXTERNAL_STORAGE ALLOW",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity.this, "READ_EXTERNAL_STORAGE DENY",Toast.LENGTH_SHORT).show();
                }
                break;

            case 2:
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(MainActivity.this, "WRITE_EXTERNAL_STORAGE ALLOW",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(MainActivity.this, "WRITE_EXTERNAL_STORAGE DENY",Toast.LENGTH_SHORT).show();
                }
                break;
